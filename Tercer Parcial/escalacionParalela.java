...
public class escalacionParalela extends JFrame implements KeyListener {
    ...
    public void paint(){
        ...
        esca(cuboDub, repintarEscalacion[0], repintarEscalacion[1], repintarEscalacion[2]);
    ...
    public void esca(int [][] cube, double Sx, double Sy, double Sz){
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_LEFT) {
            repintarEscalacion[0] = repintarEscalacion[0] - 0.02;
        }
        if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
            repintarEscalacion[0] = repintarEscalacion[0] + 0.02;
        }
        if (e.getKeyCode() == KeyEvent.VK_UP) {
            repintarEscalacion[1] = repintarEscalacion[1] - 0.02;
        }
        if (e.getKeyCode() == KeyEvent.VK_DOWN) {
            repintarEscalacion[1] = repintarEscalacion[1] + 0.02;
        }
        if (e.getKeyCode() == KeyEvent.VK_Z) {
            repintarEscalacion[2] = repintarEscalacion[2] - 0.02;
        }
    ...
    public static void main(String[] args) {
        escalacionParalela b = new escalacionParalela();
    }
}
