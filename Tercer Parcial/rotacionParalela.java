...
public class rotacionParalela extends JFrame implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_UP) {
            repintarRotacion[1] = repintarRotacion[1] - Math.PI/32;
        }
    ...
    public static void main(String[] args) {
        rotacionParalela b = new rotacionParalela();
    }
}
