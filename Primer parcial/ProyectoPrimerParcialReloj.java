...
public class ProyectoPrimerParcialReloj extends javax.swing.JFrame{
    ...
    public ProyectoPrimerParcialReloj() {
        setTitle("Reloj - Proyecto");
        setSize(510,530);
...
public static void main(String args[]) {
        new ProyectoPrimerParcialReloj().setVisible(true);
...
class ClockDial extends JPanel{
    ...
    ProyectoPrimerParcialReloj parent;
    public ClockDial(ProyectoPrimerParcialReloj pt){
        setSize(520,530);
        parent=pt;
    }
    ...
    public void paintComponent(Graphics g){
        g.setColor(new Color(255, 241, 139));
